# sunFTP
Clone of delphi SunFTP project


I noticed a while ago the sunFTP project had fallen into disuse, 
it had well known issues with malformed connections still to be fixed, but 
was otherwise a fully functional project, at some point the original website 
went offline, and no further updates ever occured. Leaving me with probably 
the only copy of the binary and sources on my reviews website.

I have posted it here in the hope someone might find it useful or even 
resurrect the project.
Below is the original readme for this project before it went dark -
